...
exports.CURRENT_DH_PRIME = exports.decompose = exports.gcd = void 0;
...
function decompose(pq) {
    ...
    let c = (0, helpers_js_1.randBigint)(BigInt(1), pq - BigInt(1));
    let m = (0, helpers_js_1.randBigint)(BigInt(1), pq - BigInt(1));
    let g = BigInt(1);
    let r = BigInt(1);
    let q = BigInt(1);
    let x = BigInt(0);
