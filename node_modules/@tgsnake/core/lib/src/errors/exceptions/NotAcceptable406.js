...
exports.UserRestricted = exports.UserpicUploadRequired = exports.UserpicPrivacyRequired = exports.TopicDeleted = exports.TopicClosed = exports.StickersetOwnerAnonymous = exports.StickersetInvalid = exports.SendCodeUnavailable = exports.PrivacyPremiumRequired = exports.PreviousChatImportActiveWaitmin = exports.PhonePasswordFlood = exports.PhoneNumberInvalid = exports.PaymentUnsupported = exports.InviteHashExpired = exports.GiftcodeNotAllowed = exports.FreshResetAuthorisationForbidden = exports.FreshChangePhoneForbidden = exports.FreshChangeAdminsForbidden = exports.FilerefUpgradeNeeded = exports.ChatForwardsRestricted = exports.ChannelTooLarge = exports.ChannelPrivate = exports.CallProtocolCompatLayerInvalid = exports.BannedRightsInvalid = exports.AuthKeyDuplicated = exports.NotAcceptable = void 0;
...
class AuthKeyDuplicated extends NotAcceptable {
    ...
    message = 'The same authorization key (session file) was used in more than one place simultaneously. You must delete your session file and log in again with your phone number or bot token';
}
...
class PaymentUnsupported extends NotAcceptable {
    ...
    message = 'A detailed description of the error will be received separately as described [here &raquo;](https://core.telegram.org/api/errors#406-not-acceptable).';
}
