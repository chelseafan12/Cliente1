...
exports.DataCenter = exports.DCProdMediaIPV6 = exports.DCProdIPV6 = exports.DCTestIPV6 = exports.DCProdMedia = exports.WebDC = exports.DCProd = exports.DCTest = void 0;
...
function DataCenter(dcId, testMode, ipv6, media) {
    if (platform_node_js_1.isBrowser) {
        return [`${exports.WebDC[dcId]}:$PORT/apiws${testMode ? '_test' : ''}`, 443];
    }
    else {
        if (testMode) {
            return [ipv6 ? exports.DCTestIPV6[dcId] : exports.DCTest[dcId], 80];
        }
        else {
            if (media) {
                return [
                    ipv6 ? exports.DCProdMediaIPV6[dcId] ?? exports.DCProdIPV6[dcId] : exports.DCProdMedia[dcId] ?? exports.DCProd[dcId],
                    443,
                ];
            }
            else {
                return [ipv6 ? exports.DCProdIPV6[dcId] : exports.DCProd[dcId], 443];
            }
        }
    }
}
