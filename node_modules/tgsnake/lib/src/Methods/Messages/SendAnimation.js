...
exports.sendAnimation = void 0;
const SendMedia_js_1 = require("./SendMedia.js");
const platform_node_js_1 = require("../../platform.node.js");
const Utilities_js_1 = require("../../Utilities.js");
const Logger_js_1 = require("../../Context/Logger.js");
async function sendAnimation(client, chatId, file, more = {}) {
    Logger_js_1.Logger.debug(`exec: send_animation chat ${typeof chatId} (${chatId}) ${(0, Utilities_js_1.parseArgObjAsStr)({
        file,
    })} ${(0, Utilities_js_1.parseArgObjAsStr)(more)}`);
    var { disableNotification, replyToMessageId, replyToStoryId, messageThreadId, scheduleDate, sendAsChannel, protectContent, replyMarkup, entities, parseMode, caption, invertMedia, filename, progress, thumbnail, mimetype, forceDocument, hasSpoiler, duration, width, height, } = more;
    if (typeof file === 'string') {
        ...
        if (/^http/i.test(file)) {
            ...
            var savedFile = new platform_node_js_1.Raw.InputMediaUploadedDocument({
                ...
                mimeType: mimetype ?? (0, Utilities_js_1.findMimeType)(filename ?? platform_node_js_1.path.basename(file) ?? '') ?? 'video/mp4',
                ...
                attributes: [
                    ...
                    new platform_node_js_1.Raw.DocumentAttributeVideo({
                        roundMessage: false,
                    ...
                    new platform_node_js_1.Raw.DocumentAttributeAnimated(),
                ],
            ...
            if (media.fileType === platform_node_js_1.FileType.ANIMATION) {
        ...
        var savedFile = new platform_node_js_1.Raw.InputMediaUploadedDocument({
            ...
            mimeType: mimetype ?? (0, Utilities_js_1.findMimeType)(filename ?? '') ?? 'video/mp4',
            forceFile: forceDocument,
            spoiler: hasSpoiler,
            attributes: [
                new platform_node_js_1.Raw.DocumentAttributeFilename({
