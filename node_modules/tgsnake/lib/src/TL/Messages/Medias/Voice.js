...
class Voice extends TL_js_1.TLObject {
    fileId;
    fileUniqueId;
    duration;
    thumb;
    ...
    mimeType;
    fileSize;
    constructor({ fileId, fileUniqueId, duration, thumb, date, dcId, performer, title, filename, mimeType, fileSize, }, client) {
        super(client);
        this.fileId = fileId;
    ...
    static parse(client, document) {
        const { fileId, fileUniqueId } = platform_node_js_1.FileId.encode({
            ...
            subVersion: 32,
            dcId: document.dcId,
            fileType: platform_node_js_1.FileType.VOICE,
        ...
        for (let attribute of document.attributes) {
            if (attribute instanceof platform_node_js_1.Raw.DocumentAttributeAudio) {
                attribute;
