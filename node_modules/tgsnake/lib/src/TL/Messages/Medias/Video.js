...
class Video extends TL_js_1.TLObject {
    fileId;
    fileUniqueId;
    width;
    height;
    ...
    mimeType;
    fileSize;
    constructor({ fileId, fileUniqueId, width, height, duration, thumb, date, dcId, filename, supportStreaming, mimeType, fileSize, }, client) {
        super(client);
        this.fileId = fileId;
    ...
    static parse(client, document) {
        const { fileId, fileUniqueId } = platform_node_js_1.FileId.encode({
            ...
            subVersion: 32,
            dcId: document.dcId,
            fileType: platform_node_js_1.FileType.VIDEO,
